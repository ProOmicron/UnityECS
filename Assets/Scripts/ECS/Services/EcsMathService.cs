...
// MVID: 127E81E1-CB34-41CC-97D2-6B1910DAAE77
// Assembly location: C:\Program Files\Unity\Hub\Editor\2020.3.11f1\Editor\Data\Managed\UnityEngine\UnityEngine.CoreModule.dll
// XML documentation location: C:\Program Files\Unity\Hub\Editor\2020.3.11f1\Editor\Data\Managed\UnityEngine\UnityEngine.CoreModule.xml
  ...
  {
    public static ECS.Services.Vector3 Vec3UnityToEcs(UnityEngine.Vector3 vector)
    {
      return new ECS.Services.Vector3(vector.x, vector.y, vector.z);
    }

    public static UnityEngine.Vector3 Vec3EcsToUnity(ECS.Services.Vector3 vector)
    {
  ...
  public struct Vector3
  {
    ...
    public bool Equals(Vector3 other) => (double)this.x == (double)other.x && (double)this.y == (double)other.y &&
    ...
    /// <param name="rhs"></param>
    [MethodImpl((MethodImplOptions)256)]
    public static float Dot(Vector3 lhs, Vector3 rhs) => (float)((double)lhs.x * (double)rhs.x +
    ...
    public static float Angle(Vector3 from, Vector3 to)
    {
      ...
      return (double)num < 1.00000000362749E-15
        ? 0.0f
        : (float)Math.Acos((double)Mathf.Clamp(Vector3.Dot(from, to) / num, -1f, 1f)) * 57.29578f;
    }
    ...
    [MethodImpl((MethodImplOptions)256)]
    public static float Magnitude(Vector3 vector) => (float)Math.Sqrt((double)vector.x * (double)vector.x +
    ...
    [MethodImpl((MethodImplOptions)256)]
    public static float SqrMagnitude(Vector3 vector) => (float)((double)vector.x * (double)vector.x +
                                                                (double)vector.y * (double)vector.y +
                                                                (double)vector.z * (double)vector.z);
    ...
    public new string ToString()
    {
      return "x: " + this.x.ToString(CultureInfo.CurrentCulture) + " y: " +
             (object)this.y.ToString(CultureInfo.CurrentCulture) + " z: " +
             (object)this.z.ToString(CultureInfo.CurrentCulture);
    }
    ...
    public static float AngleBetween(Vector3 from, Vector3 to) =>
      (float)Math.Acos((double)Mathf.Clamp(Vector3.Dot(from.normalized, to.normalized), -1f, 1f));

    [Obsolete("Use Vector3.ProjectOnPlane instead.")]
    public static Vector3 Exclude(Vector3 excludeThis, Vector3 fromThat) =>
      Vector3.ProjectOnPlane(fromThat, excludeThis);
